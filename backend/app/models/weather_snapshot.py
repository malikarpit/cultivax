...
class WeatherSnapshot(BaseModel):
    ...
    location_key = Column(String, index=True, nullable=False)  # e.g. "geohash_w3q2" or "lat_lng_bucket"
    lat = Column(Float, nullable=True)
    lng = Column(Float, nullable=True)

    provider_source = Column(String, nullable=False)  # "openweathermap", "historical_fallback", "mock"

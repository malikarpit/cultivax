...
from app.api.v1.account import \
    router as account_router  # NFR-16/17 data export/delete
from app.api.v1.alerts import router as alerts_router
from app.api.v1.analytics import router as analytics_router  # Analytics
from app.api.v1.config import router as config_router  # Extensibility Config
from app.api.v1.consent import router as consent_router  # NFR-13 user consent
from app.api.v1.csp_report import \
    router as csp_report_router  # CSP violation ingestion
from app.api.v1.dashboard import router as dashboard_router
from app.api.v1.disputes import \
    router as disputes_router  # FR-33 dispute resolution
from app.api.v1.features import router as features_router
from app.api.v1.health import \
    router as health_router  # API-0150 /api/v1/health
...
from app.api.v1.operations import \
    router as operations_router  # API-0108 operations status
from app.api.v1.recommendations import router as recommendations_router
from app.api.v1.reports import router as reports_router  # Reporting
from app.api.v1.reviews import router as reviews_router
from app.api.v1.rules import router as rules_router
from app.api.v1.schemes import \
    router as schemes_router  # FR-31 official portal redirect
from app.api.v1.service_requests import router as service_requests_router
from app.api.v1.sync import \
    crops_sync_router  # API-0103 /crops/{id}/sync-batch
...
api_router.include_router(schemes_router)  # FR-31: /api/v1/schemes
api_router.include_router(
    disputes_router
)  # FR-33: /api/v1/disputes + /api/v1/admin/disputes
api_router.include_router(consent_router)  # NFR-13: /api/v1/consent
api_router.include_router(account_router)  # NFR-16/17: /api/v1/account
